  ...
  d3.json("assets/units.geojson").then((data) => {
    ...
    d3.json("assets/census.geojson").then((seattle) => {
      ...
      svg.append('g').selectAll('path')
          ...
          tooltip
            .html(
              `<span style="font-size:20px">Address: ${d.properties.ADDRESS}<br></span><span style="font-size:20px">Net Units: ${d.properties.NET_UNITS}<span style="font-size:20px"><br>VALUE ${d.properties.VALUE}<br></span>`
            )
